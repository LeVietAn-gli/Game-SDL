...
// TEXTURE
    ...
    void render(int x, int y, const Sprite& sprite, double angle = 0.0) {
        const SDL_Rect* clip = sprite.getCurrentClip();
        SDL_Rect renderQuad = {x, y, clip->w - 90 , clip->h - 90 };
        SDL_RenderCopyEx(renderer, sprite.texture, clip, &renderQuad, angle, nullptr, SDL_FLIP_NONE);
    }
